...
public class Allow2 {
    ...
    // todo: should do this better
    public static var allow2BlockView: Allow2BlockView {
        get {
           Allow2BlockView()
        }
    }
    ...
    // todo: should do this better
    public static var allow2LoginView: Allow2LoginView {
        get {
            Allow2LoginView()
        }
    }
    ...
    // todo: should do this better
    public static var allow2PairingView : Allow2PairingView {
        get {
            Allow2PairingView()
        }
    }
    ...
    // todo: should do this better
    public static var allow2RequestView: Allow2RequestView {
        get {
            Allow2RequestView()
        }
    }
...
// 1.
public struct Allow2BlockView: UIViewControllerRepresentable {

    public func makeUIViewController(context: Context) -> UIViewController {
        return Allow2.allow2BlockViewController
    }
...
public struct Allow2LoginView: UIViewControllerRepresentable {

    public func makeUIViewController(context: Context) -> UIViewController {
        return Allow2.allow2LoginViewController
    }
...
public struct Allow2PairingView: UIViewControllerRepresentable {

    public func makeUIViewController(context: Context) -> UIViewController {
        return Allow2.allow2PairingViewController
    }
...
public struct Allow2RequestView: UIViewControllerRepresentable {

    public func makeUIViewController(context: Context) -> UIViewController {
        return Allow2.allow2RequestViewController
    }
